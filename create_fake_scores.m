...
for l=1:number_of_lectures
    ...
    for g=1:number_of_groups
        ...
        if g <= number_of_groups - rest
            ...
            students_r1 = class_final(idx1(1+(g-1)*std_per_group:g*std_per_group+1));
            students_r2 = class_final(idx2(1+(g-1)*std_per_group:g*std_per_group+1));
        end
        score_file.(lecture_name).('r1').(strcat('group', num2str(g))). ...
            students = students_r1;
        score_file.(lecture_name).('r2').(strcat('group', num2str(g))). ...
            students = students_r2;
